...
class PlayBackAndRecordTracked:    
    def __init__(self):  
        ...
        self.scan_topic = rospy.get_param("radar_scan_topic", None)
        ...
        self.radar_pub = rospy.Publisher(self.scan_topic, PointCloud, queue_size=10)
        ...
        self.people_tracked_sub = rospy.Subscriber('radar_tracked_people', PersonArray, self.people_tracked_callback)
    ...
    def people_tracked_callback(self, people_tracked_msg):    
        ...
        if self.savebag_filename is not None:
            ...
            self.savebag.write('/radar_tracked_people', people_tracked_msg, save_time)
            ...
            try:
                ...
                if topic == self.scan_topic:
                    ...
                    if topic == "/tf":
                        ...
                        if self.savebag_filename is not None:
                            self.savebag.write(topic, msg, time)
                    elif topic == "/radar_ground_truth_people_tracks":
                        if self.savebag_filename is not None:
                            self.savebag.write(topic, msg, time)

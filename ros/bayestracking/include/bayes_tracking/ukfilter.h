...
public:
   ...
   * @param z
   */
  void update(Additive_predict_model& predict_model, Correlated_additive_observe_model& observe_model,
              const FM::Vec& z);
   ...
   */
  void predict_observation(Correlated_additive_observe_model& observe_model, FM::Vec& z_pred, FM::SymMatrix& R_pred);
   ...
   */
  Bayes_base::Float observeInnovation(Correlated_additive_observe_model& h, const Vec& si, const SymMatrix& Si);

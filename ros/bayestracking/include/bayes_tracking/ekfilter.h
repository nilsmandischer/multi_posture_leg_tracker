...
public:
   ...
   * @param z
   */
  void update(Linrz_predict_model& predict_model, Linrz_correlated_observe_model& observe_model, const FM::Vec& z);
   ...
   */
  void predict_observation(Linrz_correlated_observe_model& observe_model, FM::Vec& z_pred, FM::SymMatrix& R_pred);
   ...
   */
  Bayes_base::Float observeInnovation(Linrz_correlated_observe_model& h, const Bayesian_filter_matrix::Vec& si,

...
PFilter::PFilter(const FM::Vec& x0, const FM::SymMatrix& P0, std::size_t s_size, SIR_random& random_helper)
...
void PFilter::predict_observation(Correlated_additive_observe_model& observe_model, FM::Vec& z_pred,
                                  FM::SymMatrix& R_pred)
{
  z_pred.clear();  // mean
